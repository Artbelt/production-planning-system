<?php
/**
 * Восстановление таблиц участка U4 из файла бэкапа — по одной или выбранным.
 * Позволяет указать путь к бэкапу и восстановить любые таблицы по отдельности.
 *
 * Запуск: в браузере — http://.../plan_U4/tools/restore_tables_from_backup.php
 */

require_once __DIR__ . '/../settings.php';

$default_backup_path = 'G:\BACKUP\plan_u4_20260201_230002.sql';
...
<head>
    ...
    <title>Восстановление таблиц из бэкапа (U4)</title>
    <style>
...
<div class="card">
    <h1>Восстановление таблиц из бэкапа (участок U4)</h1>
    ...
    <form method="post" id="formPath">
        ...
        <input type="text" name="backup_path" id="backup_path" value="<?= h($backup_path) ?>" placeholder="G:\BACKUP\plan_u4_20260201_230002.sql">
