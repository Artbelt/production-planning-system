...
<script> /* Загрузка выпущенной продукции */
    function load_manufactured_parts(object_id){
        ...
        xhttp.open("POST", "manufactured_parts_editor_processing.php", true);
...
<div id="header" style="background-color: #5450ff; height: 50px; width: 100%; font-family: Calibri; font-size: 20px">
    ...
    <label>Выбор выпущенных комплектующих по дате:</label><p>
    <input type="date" id="selected_date">

    <button onclick="load_manufactured_parts(document.getElementById('selected_date'))">Выбрать / Обновить</button>
