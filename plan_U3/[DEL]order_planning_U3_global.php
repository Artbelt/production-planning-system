        ...
        if($diff < 0.8){
            echo
               ...
               // ."<td>".$row['count']."diff=".$diff."</td>"
                ...
                ."<td>".show_prepared_caps($row['filter']).'H='.get_filter_data($row['filter'])['paper_package_fold_height']."мм</td>"
                ."</tr>";
        }else{
            echo // если можно считать позицию закрытой
                "<tr>"
                ."<td style='background-color: lightgreen'>".$row['order_number']."</td>"
                ."<td style='background-color: lightgreen'>".$row['filter']."</td>"
                ."<td style='background-color: lightgreen'>".$row['count']."</td>"
                ."<td style='background-color: lightgreen'>".select_produced_filters_by_order($row['filter'],$order)[1]."</td>"
                ."<td style='background-color: lightgreen'>".$difference."</td>"
                ."<td style='background-color: lightgreen'>0</td>"
                ."<td style='background-color: lightgreen'>".$difference."</td>"
                ."<td style='background-color: lightgreen'>".count_of_manufactured_parts_in_the_storage($row['filter'])."</td>"
                ."<td style='background-color: lightgreen'>".show_prepared_caps($row['filter']).'H='.get_filter_data($row['filter'])['paper_package_fold_height']."мм</td>"
                ."</tr>";
        }
