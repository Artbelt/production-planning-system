<?php
/**
 * Восстановление таблиц участка U3 из файла бэкапа — по одной или выбранным.
 * Позволяет указать путь к бэкапу и восстановить любые таблицы по отдельности.
 *
 * Запуск: в браузере — http://.../plan_U3/tools/restore_tables_from_backup.php
 */

require_once __DIR__ . '/../settings.php';

$default_backup_path = 'G:\BACKUP\plan_u3_20260201_230002.sql';
...
<head>
    ...
    <title>Восстановление таблиц из бэкапа (U3)</title>
    <style>
        ...
        .btn { padding: 10px 18px; border-radius: 8px; border: none; font-weight: 600; cursor: pointer; font-size: 14px; text-decoration: none; display: inline-block; }
...
<div class="card">
    <h1>Восстановление таблиц из бэкапа (участок U3)</h1>
    ...
    <form method="post" id="formPath">
        ...
        <input type="text" name="backup_path" id="backup_path" value="<?= h($backup_path) ?>" placeholder="G:\BACKUP\plan_u3_20260201_230002.sql">
