<?php
/**
 * Восстановление таблицы salon_filter_structure из файла бэкапа (участок U3).
 * Запуск: в браузере или из консоли: php restore_salon_filter_structure_from_backup.php
 *
 * Бэкап: по умолчанию G:\BACKUP\plan_u3_20260201_230002.sql
 * Параметры БД из settings.php (plan_U3, root, без пароля).
 */

$backup_path = 'G:\BACKUP\plan_u3_20260201_230002.sql';
