...
echo "<form action='prepared_order_for_spare_parts.php' method='post' target='_blank'>";
echo "<input type='submit' value='Подготовить заявку на поставку крышек'>";
echo "<input type='hidden' name='order' value='".$order_number."'>";
echo "<input type='hidden' name='part' value='caps'><br>";
echo "</form>";

echo "<form action='prepared_order_for_spare_parts.php' method='post' target='_blank'>";
echo "<input type='submit' value='Подготовить заявку на поставку вставок PP'>";
echo "<input type='hidden' name='order' value='".$order_number."'>";
echo "<input type='hidden' name='part' value='insertions'><br>";
echo "</form>";
