...
<head>
    ...
    <title>Обзор выпуска каркасов</title>
    <style>
        :root{
            --bg:#f6f7f9;
            --panel:#ffffff;
        ...
        #show_wireframes_place table, table {
            width: 100% !important;
        ...
        #show_wireframes_place table th,
        #show_wireframes_place table td,
        table th,
        table td {
...
<div class="container">
    <div class="panel">
        <div class="section-title">Обзор выпуска каркасов</div>
        <p class="muted">Просмотр и анализ изготовленных каркасов по датам</p>
    </div>
    ...
    <div class="panels-row">
        <div class="panel">
            ...
            <button type="button" onclick="show_one()">📅 Просмотр выпущенных за выбранную дату</button>
        </div>
        ...
        <div class="panel">
            ...
            <button type="button" onclick="show_range()">📊 Просмотр выпущенных в заданном диапазоне дат</button>
        </div>
    </div>

    <div class="panel">
        <div id="show_wireframes_place"></div>
    </div>
...
<script>
    function show_one() {
        ...
        post('show_wireframes_fact.php', 'date=' + encodeURIComponent(d));
    }
    ...
    function show_range() {
        ...
        post('show_wireframes_fact_range.php', 'start=' + encodeURIComponent(s) + '&end=' + encodeURIComponent(e));
    }
    ...
    function post(url, body) {
        ...
        x.onreadystatechange = function() {
            if (this.readyState === 4) {
                if (this.status === 200) {
                    document.getElementById('show_wireframes_place').innerHTML = this.responseText;
                } else {
