...
/** Таблица удаления */
echo '<form id="delete_form" action="delete_record_for_parts.php" method="post">';
echo "<table  id='main_table' border='1' style='font-size: 13px'><tr><td width='180' style='color: red'><center><b>УДАЛЕНИЕ ЗАПИСИ</b></center></td><td width='120''> Дата производства </td><td width='120'> Комплектующее </td><td> Количество </td><td width='120'> Заявка </td><td>Действие</td>";
echo '<tr>';
...
echo '<td> <input type="text" form="delete_form" name="name_of_parts" value="'.$name_of_parts.'" size="22" readonly /></td>';
echo '<td><input type="text" form="delete_form" name="count_of_parts" value="'.$count_of_parts.'" size="3" readonly/></td>';
...
echo '<form id="edit_form" action="edit_record_for_parts.php" method="post">';
...
echo '<td> <input type="text" form="edit_form" name="name_of_parts" value="'.$name_of_parts.'" size="22" readonly /></td>';
echo '<td><input type="text" form="edit_form" name="count_of_parts" value="'.$count_of_parts.'" size="3" readonly /></td>';
...
echo '<td>'.$name_of_parts.'</td>';
echo '<td><input type="text" form="edit_form" name="new_count_of_parts" value="'.$count_of_parts.'" size="3"   /></td>';
echo '<td>';
