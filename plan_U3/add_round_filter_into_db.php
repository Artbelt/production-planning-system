...
<head>
    <meta charset="utf-8" />
    <title>Добавление нового круглого фильтра в БД</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .filter-image img{max-width:180px; height:auto; border-radius:var(--radius); border:1px solid var(--border); object-fit:contain}
...
<div class="container">
    ...
    <header class="top">
        <div class="title">Добавление нового круглого фильтра</div>
        <div class="badge">
    ...
    <?php if ($analog_filter !== ''): ?>
        <p class='muted' style='margin:8px 2px 18px'>Загружен прототип: <b><?= htmlspecialchars($analog_filter) ?></b></p>
    <?php else: ?>
        <p class='muted' style='margin:8px 2px 18px'>Прототип не выбран</p>
    <?php endif; ?>
