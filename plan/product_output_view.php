...
<script>
    ...
    function show_manufactured_filters() {//отправка данных для списания выпуска продукции
        ...
        document.getElementById("show_filters_place").innerHTML = '<div style="text-align:center;padding:40px;"><div class="loader"></div><p style="margin-top:20px;color:#666;">Загрузка данных...</p></div>';
