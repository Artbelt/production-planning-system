 ...
 * за конкретную дату (аналог plan_U5/get_corrugation_details.php)
 */
...
try {
    ...
    if ($tableCheck->num_rows === 0) {
        echo json_encode(['error' => 'Таблица manufactured_corrugated_packages не найдена']);
        $mysqli->close();
        exit;
    }
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Плановая дата гофрирования (из corrugation_plan)
        $planned_dates_str = '';
