...
function cut_execute($cut_array, $width_of_main_roll, $max_gap, $min_gap){
    ...
    /** Начальное перемешивание: при каждой загрузке страницы пробуем другой порядок рулонов
     *  (внутри групп по высоте), чтобы при обновлении страницы получить другую упаковку и возможно меньше остатков */
